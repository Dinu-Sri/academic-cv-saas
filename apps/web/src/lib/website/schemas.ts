...
export const enabledPagesSchema = z.object({
  ...
  journey: z.boolean().default(true),
...
export const sectionVisibilitySchema = z.object({
  ...
  invitedTalks: z.boolean().default(true),
  academicService: z.boolean().default(true),
...
export const pageContentSchema = z.object({
  ...
  journeyNarrative: z.string().max(8000).default(""),
  contributionsNarrative: z.string().max(8000).default(""),
...
export const featuredContentSchema = z.object({
  ...
  featuredEntryIds: z.array(z.string()).max(40).default([])
});
