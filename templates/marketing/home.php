...
<section class="mk-section mk-section-alt">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="mk-section-subtitle">Open live sample PDFs generated by the same LaTeX engine used inside CVScholar.</p>
        </div>

        <div class="mk-pdf-template-rack">
            <?php
            $cvExamples = [
                ['id' => 1, 'name' => 'Classic Academic', 'template' => 'Classic', 'description' => 'Traditional academic CV with clean publication-ready structure.'],
                ['id' => 4, 'name' => 'Classic Faculty', 'template' => 'Classic', 'description' => 'Restrained faculty CV for appointments, teaching, and service records.'],
                ['id' => 2, 'name' => 'Modern Professional', 'template' => 'Modern', 'description' => 'Contemporary academic CV with compact hierarchy and crisp spacing.'],
                ['id' => 3, 'name' => 'Detailed Academic', 'template' => 'Detailed', 'description' => 'Comprehensive format for senior academic and long-form records.'],
                ['id' => 5, 'name' => 'European Formal', 'template' => 'EU Formal', 'description' => 'Formal A4 academic CV for European applications and dossiers.'],
                ['id' => 6, 'name' => 'Research Dossier', 'template' => 'Dossier', 'description' => 'Dense research-focused dossier for publications and grants.'],
            ];
            foreach ($cvExamples as $cv):
            ?>
            <button type="button"
                 class="mk-pdf-template-card"
...
<div class="modal fade" id="marketingDemoPreviewModal" tabindex="-1" aria-labelledby="marketingDemoPreviewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" style="max-width: 900px;">
        <div class="modal-content" style="height: 85vh;">
            <div class="modal-header py-2">
                <h6 class="modal-title" id="marketingDemoPreviewModalLabel">Template Preview</h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-0 d-flex align-items-center justify-content-center" style="flex: 1; min-height: 0;">
                <div id="marketingDemoLoadingSpinner" class="text-center py-5">
                    <div class="spinner-border text-primary" role="status">
                        <span class="visually-hidden">Loading...</span>
                    </div>
                    <p class="text-muted mt-2 mb-0">Generating real LaTeX preview...</p>
                </div>
                <iframe id="marketingDemoPreviewFrame" title="Sample CV PDF preview" style="width: 100%; height: 100%; border: none; display: none;"></iframe>
            </div>
        </div>
    </div>
</div>
