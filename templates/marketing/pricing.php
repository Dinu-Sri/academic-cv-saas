...
<section class="mk-section pt-4">
    <div class="container">
        <div class="text-center mb-5">
            <h1 class="mk-section-title">Simple, Transparent Pricing</h1>
            <p class="mk-section-subtitle">Start for free. Upgrade when you need more. No hidden fees, no surprises.</p>
        </div>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="mk-pricing-card">
                    ...
                    <div class="mk-pricing-price">$0</div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="mk-pricing-card">
                    ...
                    <div class="mk-pricing-price">Custom</div>
...
<section class="mk-section mk-section-alt">
    <div class="container">
        <h2 class="text-center mk-section-title mb-5">Full Feature Comparison</h2>
...
<section class="mk-cta-section">
    <div class="container">
        ...
        <p class="mt-3 mb-4 opacity-75">Free forever. Upgrade only if you need more. Cancel anytime.</p>
