    ...
    <div class="auth-split">
        ...
        <div class="auth-form-side">
            <div class="auth-form-wrapper">
                ...
                <p class="text-muted mb-4">Start building your professional academic CV today.</p>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control form-control-lg" id="password" name="password"
                                   required minlength="<?= PASSWORD_MIN_LENGTH ?>" placeholder="Min <?= PASSWORD_MIN_LENGTH ?> chars">
                        </div>
                        <div class="col-md-6 mb-3">
                ...
                <a href="<?= APP_URL ?>/auth/google" class="btn btn-outline-dark btn-lg w-100 d-flex align-items-center justify-content-center">
